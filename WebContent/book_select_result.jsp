		...
		<div class="card-body">
			...
			<%
					...
					try {
						...
						if (search == null & enter == null) { //전부 공백일 경우
							pstmt = conn.prepareStatement("select * from book_info");
						} else if (search != null & enter.equals("")) { //검색하는 곳만 공백일 경우
							pstmt = conn.prepareStatement("select * from book_info");
						} else if (search != null & enter != null) { //둘다 조건있는 경우
							pstmt = conn.prepareStatement("select * from book_info where " + search + "=?");
