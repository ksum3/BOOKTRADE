		...
		<div class="collapse navbar-collapse justify-content-end"
			...
			<ul class="navbar-nav">
				<li class="nav-item active"><a class="nav-link"
					href="./adminpage-member.jsp">회원관리<span class="sr-only">(current)</span></a></li>
		...
		<div class="card-body">
				<%
					try {
						...
						out.println("<thead><tr><th>ID</th><th>PW</th><th>성명</th><th>학과</th><th>이메일</th><th>전화번호</th><th></th></tr></thead>");
						out.println("<tbody>");
						while (rs.next()) {
							...
							out.println("<td width=200><a href='./deletemember.jsp?_id="+id+"'>삭제</a></td>");
							out.println("</tr>");
						}
