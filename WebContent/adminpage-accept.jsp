				...
				<%
					try {
						...
						ResultSet rs = stmt.executeQuery(
								"select * from trade_info, book_regist_info where return_check=1 and trade_info.trade_regist_id=book_regist_info.book_regist_Id");

						out.println("<table class='table table-hover'>");
						out.println("<thead><tr><th>도서ID</th><th>판매자</th><th>구매자</th><th>대여시작일</th><th>대여종료일</th><th></th><th></th></tr></thead>");
						out.println("<tbody>");
						while (rs.next()) {
							...
							out.println("<td width=50><a href='./accept.jsp?buyer_id="+buyer_id+"&trade_regist_Id="+trade_regist_Id+"'>수락</a></td>");
							out.println("<td width=50><a href='./reject.jsp?buyer_id="+buyer_id+"&trade_regist_Id="+trade_regist_Id+"'>거절</a></td>");
							out.println("</tr>");
						}
